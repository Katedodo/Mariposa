const polishCopy = new Map([
  ...
  ['A new digital home', 'Nowe miejsce online'], ['for', 'dla'],
  ...
  ['Before defining website features, we connect Mariposa’s current business reality with the customer need and the strongest opportunity for the brand.', 'Zanim określimy funkcje strony, analizujemy obecną sytuację Mariposa, potrzeby klientów i największą szansę na rozwój marki.'],
  ...
  ['People want a meaningful gesture without organising every detail themselves.', 'Ludzie chcą zrobić dla kogoś coś wyjątkowego, bez konieczności samodzielnego planowania każdego szczegółu.'],
  ['03 · STRATEGIC OPPORTUNITY', '03 · SZANSA STRATEGICZNA'], ['Own the complete moment', 'Stwórz kompletne doświadczenie'],
  ['Connect flowers, coffee and dessert in one offer competitors cannot reproduce authentically.', 'Połącz kwiaty, kawę i deser w ofertę, której konkurencja nie jest w stanie wiarygodnie odtworzyć.'],
  ...
  ['Create a direct digital sales channel that makes the Mariposa idea easy to discover and buy.', 'Stwórz bezpośredni kanał sprzedaży, który ułatwi poznanie marki Mariposa i złożenie zamówienia.'],
  ...
  ['01 · MARKET & REFERENCES', '01 · RYNEK I INSPIRACJE'],
  ['LEARN THE MECHANICS — KEEP THE IDENTITY', 'KORZYSTAJ ZE SPRAWDZONYCH ROZWIĄZAŃ — ZACHOWAJ WŁASNY STYL'], ['Three references.', 'Trzy inspiracje.'], ['One', 'Jeden'], ['clear direction.', 'jasny kierunek.'],
  ...
  ['Mariposa needs visibility for its flower offer. We identify what creates desire, clarity and trust — then combine it with the brand’s own advantage.', 'Oferta kwiatowa Mariposa potrzebuje większej widoczności. Sprawdzamy, co buduje atrakcyjność, przejrzystość i zaufanie — a następnie łączymy to z własną przewagą marki.'],
  ['DESIRE', 'ATRAKCYJNOŚĆ'], ['CLARITY', 'PRZEJRZYSTOŚĆ'], ['TRUST', 'ZAUFANIE'], ['WHAT WORKS', 'CO DZIAŁA'], ['FOR MARIPOSA', 'DLA MARIPOSA'],
  ['A recognisable house style: editorial photography, soft palettes, generous floral shapes and a consistent premium point of view.', 'Rozpoznawalny styl marki: edytorialowe zdjęcia, delikatna kolorystyka, efektowne kompozycje kwiatowe i spójny, ekskluzywny charakter.'],
  ['Create a distinctive image language, signature product names and photography that makes the catalogue feel curated rather than generic.', 'Stworzyć własny język wizualny, charakterystyczne nazwy produktów i zdjęcia, dzięki którym katalog będzie przypominał przemyślaną kolekcję, a nie przypadkowy zestaw produktów.'],
  ['A direct, product-first shopping model gives customers the familiar basics: visible bouquets, prices and a clear route to purchase.', 'Prosty model sprzedaży, skupiony na produktach, zapewnia klientom to, czego oczekują: dobrze widoczne bukiety, ceny i łatwy proces zakupu.'],
  ...
  ['Show availability, pricing and checkout steps upfront; add social proof as it grows and make every order feel predictable and safe.', 'Od razu pokazać dostępność, ceny i etapy zakupu; z czasem dodać opinie klientów, aby cały proces był przejrzysty i budził zaufanie.'],
  ...
  ['A customer may come for flowers — then add coffee and dessert in the same order. Mariposa turns one purchase into a thoughtful, ready-to-enjoy experience that an ordinary florist cannot offer authentically.', 'Klient może wybrać kwiaty, a następnie dodać kawę i deser w ramach jednego zamówienia. Mariposa tworzy w ten sposób kompletną oprawę wyjątkowej chwili — coś, czego zwykła kwiaciarnia nie może zaoferować równie naturalnie.'],
  ['MORE VALUE PER ORDER', 'WIĘKSZA WARTOŚĆ ZAMÓWIENIA'], ['ONE EASY CHECKOUT', 'JEDEN PROSTY PROCES ZAKUPU'], ['A COMPLETE GIFT', 'GOTOWY PREZENT'], ['A MEMORABLE DIFFERENCE', 'WYRAŹNA RÓŻNICA'],
  ['The website makes this unique combination visible, desirable and easy to buy.', 'Strona pokaże tę wyjątkową ofertę w atrakcyjny sposób i pozwoli łatwo ją zamówić.'],
  ['03 · THE CUSTOMER', '03 · KLIENT'], ['PSYCHOLOGICAL PROFILE', 'PROFIL PSYCHOLOGICZNY'], ['THE CUSTOMER OUTCOME', 'EFEKT DLA KLIENTA'],
  ['The thoughtful planner', 'Ktoś, kto dba o każdy szczegół'], ['Prepared · confident · ready to enjoy the moment', 'Przygotowany · pewny wyboru · gotowy cieszyć się chwilą'],
  ...
  ['No last-minute searching or coordination. They arrive feeling thoughtful and completely ready.', 'Bez nerwowego szukania i załatwiania wszystkiego w ostatniej chwili. Klient przychodzi spokojny, przygotowany i pewny swojego wyboru.'],
  ['Mariposa does more than sell products. It removes the organisation behind a meaningful gesture and gives the customer confidence in the result.', 'Mariposa nie tylko sprzedaje produkty. Przejmuje przygotowania związane z wyjątkowym gestem i daje klientowi pewność, że wszystko będzie dopracowane.'],
  ['04 · CUSTOMER FLOW', '04 · ŚCIEŻKA KLIENTA'], ['FROM DESIRE TO ORDER', 'OD POMYSŁU DO ZAMÓWIENIA'], ['FOUR SIMPLE STEPS', 'CZTERY PROSTE KROKI'],
  ...
  ['THE RESULT', 'EFEKT'], ['More orders. Less admin. More time to create.', 'Więcej zamówień. Mniej formalności. Więcej czasu na tworzenie kompozycji.'],
  ['05 · EARLY CONCEPT', '05 · WSTĘPNA KONCEPCJA'], ['NOT THE FINAL DESIGN', 'TO NIE JEST OSTATECZNY PROJEKT'], ['SCHEMATIC PREVIEW', 'WSTĘPNY PODGLĄD'],
  ['This only shows', 'To pokazuje jedynie'], ['how it could work.', 'jak może to działać.'],
  ['The visual design will be created from scratch after the strategy stage. These screens demonstrate structure and customer flow — not the final look.', 'Oprawa wizualna powstanie od podstaw po zakończeniu etapu strategicznego. Te ekrany pokazują jedynie strukturę strony i ścieżkę klienta, a nie jej docelowy wygląd.'],
  ...
  ['This is not a simple brochure website. It combines strategy, bespoke design, product sales, booking, payment, SEO foundations and the operational setup behind every order.', 'To nie jest prosta strona-wizytówka. Projekt obejmuje strategię, autorską oprawę graficzną, sprzedaż produktów, rezerwacje, płatności, podstawy SEO oraz zaplecze potrzebne do obsługi zamówień.'],
  ...
  ['Pickup first', 'Najpierw odbiór'], ['At checkout, customers select an available date and time to collect their order from Mariposa.', 'Przy finalizacji zamówienia klient wybiera dostępny dzień i godzinę odbioru w Mariposa.'],
  ['Delivery later', 'Dostawa później'], ['Delivery is not required for the first launch. We can develop and connect it later, after Mariposa signs agreements with local delivery companies.', 'Na pierwszym etapie nie musimy uruchamiać dostawy. Możemy dodać ją później, gdy Mariposa podpisze umowy z lokalnymi firmami kurierskimi.'],
  ...
  ['09 · INVESTMENT', '09 · INWESTYCJA'], ['PROJECT SUMMARY', 'PODSUMOWANIE PROJEKTU'], ['Full project value', 'Pełna wartość projektu'], ['Personal discount', 'Specjalny rabat'],
  ['YOUR PROJECT FEE', 'CENA DLA CIEBIE'], ['A personal discount, offered because Nurlana is part of your team.', 'Specjalny rabat ze względu na to, że Nurlana jest częścią Twojego zespołu.'],
  ...
  ['BONUS', 'BONUS'], ['Russian website version included free to reach Warsaw’s Russian-speaking community.', 'Rosyjska wersja strony w cenie — z myślą o rosyjskojęzycznej społeczności Warszawy.'],
  ['TO BEGIN', 'NA START'], ['40% deposit · €2,000', 'Zaliczka 40% · €2,000'], ['Remaining balance can be paid in instalments according to an agreed schedule.', 'Pozostałą kwotę można zapłacić w ratach według wspólnie ustalonego harmonogramu.'],
  ...
  ['Questions? I’m always happy to talk.', 'Masz pytania? Chętnie o wszystkim opowiem.'], ['Back to WhatsApp', 'Napisz na WhatsAppie']
]);
