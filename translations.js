const polishCopy = new Map([
  ['E-COMMERCE WEBSITE PROPOSAL', 'PROPOZYCJA SKLEPU INTERNETOWEGO'],
  ...
  ['03 · STRATEGIC OPPORTUNITY', '03 · SZANSA STRATEGICZNA'], ['Own the complete moment', 'Stwórz kompletny moment'],
  ...
  ['People don’t buy flowers.', 'Ludzie nie kupują kwiatów.'], ['They buy a', 'Kupują'], ['reason.', 'powód.'], ['WHY NOW', 'DLACZEGO TERAZ'],
  ...
  ['REFERENCE', 'REFERENCJA'], ['Uses strong art direction and curated products to turn browsing into desire.', 'Wykorzystuje wyrazisty kierunek artystyczny i starannie dobrane produkty, aby zamienić oglądanie w pragnienie zakupu.'],
  ...
  ['01.1 · REFERENCE ANALYSIS', '01.1 · ANALIZA REFERENCJI'], ['WHAT MARIPOSA CAN USE', 'CO MOŻE WYKORZYSTAĆ MARIPOSA'],
  ['LEARN THE MECHANICS — KEEP THE IDENTITY', 'POZNAJ MECHANIKĘ — ZACHOWAJ TOŻSAMOŚĆ'], ['Three references.', 'Trzy referencje.'], ['One', 'Jeden'], ['clear direction.', 'jasny kierunek.'],
  ['We are not copying a competitor’s look. We are identifying what builds desire, trust and an easy purchase — then combining it with Mariposa’s own advantage.', 'Nie kopiujemy wyglądu konkurencji. Sprawdzamy, co buduje pragnienie, zaufanie i ułatwia zakup — a następnie łączymy to z własną przewagą Mariposa.'],
  ['DESIRE', 'PRAGNIENIE'], ['CLARITY', 'JASNOŚĆ'], ['TRUST', 'ZAUFANIE'], ['WHAT WORKS', 'CO DZIAŁA'], ['FOR MARIPOSA', 'DLA MARIPOSA'],
  ...
  ['Strong reassurance through visible prices, secure payment options, pickup and delivery information, customer reviews and clear service promises.', 'Buduje poczucie bezpieczeństwa dzięki widocznym cenom, płatnościom online, informacjom o odbiorze i dostawie, opiniom oraz jasnym zasadom.'],
  ...
  ['Lacy Bird’s desirability ＋ Flower Bar’s conversion clarity ＋ Mariposa’s flowers, coffee and dessert.', 'Atrakcyjność Lacy Bird ＋ jasność zakupowa Flower Bar ＋ kwiaty, kawa i deser od Mariposa.'],
  ...
  ['Mariposa does more than sell products. It removes the organisation behind a meaningful gesture and gives the customer confidence in the result.', 'Mariposa robi więcej niż sprzedawanie produktów. Usuwa wysiłek organizacyjny stojący za ważnym gestem i daje klientowi pewność rezultatu.'],
  ...
  ['No DMs.', 'Bez wiadomości.'], ['No waiting.', 'Bez czekania.'], ['Browse', 'Przeglądaj'], ['Choose', 'Wybierz'], ['Checkout', 'Zamów'], ['Pay', 'Zapłać'],
  ...
  ['Product pages', 'Karty produktów'], ['Photos, sizes, add-ons and notes', 'Zdjęcia, rozmiary, dodatki i bileciki'], ['Cart & checkout', 'Koszyk i checkout'],
  ['Complete order flow on mobile and desktop', 'Pełna ścieżka zamówienia na telefonie i komputerze'], ['Online payment', 'Płatność online'], ['Pickup calendar', 'Kalendarz odbioru'],
  ['Available date and time selection', 'Wybór dostępnej daty i godziny'], ['About & contact', 'O nas i kontakt'], ['Story, location and opening hours', 'Historia, lokalizacja i godziny otwarcia'],
  ...
  ['BONUS', 'BONUS'], ['Russian website version included free to reach Warsaw’s Russian-speaking community.', 'Rosyjska wersja strony w cenie, aby dotrzeć do rosyjskojęzycznej społeczności Warszawy.'],
